...
namespace EduOrgAMS.Client.Cryptography.Windows
{
    public static class WindowsCipherManager
    {
        public static string Encrypt(string data, string additionalKey = "EduOrgAMS.Client")
        {
        ...
        public static string Decrypt(string data, string additionalKey = "EduOrgAMS.Client")
        {
            if (string.IsNullOrWhiteSpace(data))
                return data;
