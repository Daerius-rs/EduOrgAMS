...
{
    public partial class EducationalSubjectsAddEdit : AddEditContent
    {
        public EducationalSubject Item { get; }

        public EducationalSubjectsAddEdit(EducationalSubject item,
